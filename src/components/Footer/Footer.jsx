    ...
    <>
      ...
      >
        ...
        <Modal.Body style={{ backgroundColor: "#1f2428", color: "white" }}>
          <p className="text-secondary">
            En <strong>Wavv Music</strong> valoramos tu privacidad.
          </p>
          ...
          <h5 className="text-white mt-4">4. Seguridad</h5>
          <p className="text-secondary">
      ...
      >
        ...
        <Modal.Body style={{ backgroundColor: "#1f2428", color: "white" }}>
          ...
          <h5 className="text-white mt-4">4. Suscripción Premium</h5>
          <p className="text-secondary">
      ...
      >
        ...
        <Modal.Body style={{ backgroundColor: "#1f2428", color: "white" }}>
          ...
          <h5 className="text-white mt-4">4. Cancelación</h5>
          <p className="text-secondary">
