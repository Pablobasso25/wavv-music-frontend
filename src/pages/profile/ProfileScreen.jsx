    ...
    try {
      ...
      if (Array.isArray(errors)) {
        Swal.fire({
          ...
          html: errors
            .map((err) => `<p style="margin: 5px 0;">• ${err}</p>`)
            .join(""),
          background: "#1a1a1a",
          color: "#f5f5f5",
                      ...
                      <div className="mt-1">
                        ...
                        {isEditing && formData.password && (
                          ...
                          >
                            ...
                            >
                              {passwordValidation.hasUpperCase ? "✅" : "❌"} Al
                              menos 1 mayúscula
                            </div>
                            <div
                              className="d-flex align-items-center mb-1"
                            ...
                            >
                              {passwordValidation.hasLowerCase ? "✅" : "❌"} Al
                              menos 1 minúscula
                            </div>
                            <div
                              className="d-flex align-items-center mb-1"
                            ...
                            >
                              {passwordValidation.hasNumber ? "✅" : "❌"} Al
                              menos 1 número
                            </div>
                            <div
                              className="d-flex align-items-center"
                              style={{
                                color: passwordValidation.hasSymbol
                                  ? "#2ecc71"
                                  : "#e74c3c",
                              }}
                            >
                              {passwordValidation.hasSymbol ? "✅" : "❌"} Al
                              menos 1 símbolo (!@#$%^&*)
                            </div>
                          </div>
                        )}
